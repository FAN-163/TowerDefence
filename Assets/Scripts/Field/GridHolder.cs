...
namespace Assets.Scripts.Field
{
    public class GridHolder : MonoBehaviour
    {
        ...
        public void CreateGrid()
        {
            ...
            float width = m_GridWidth * nodeSize;
            float height = m_GridHeight * nodeSize;
            ...
            m_Offset = transform.position - (new Vector3(width, 0.0f, height) * 0.5f);

            m_Grid = new Grid(m_GridWidth, m_GridHeight, m_Offset, nodeSize, m_StartCoordinate, m_TargetCoordinate);
        ...
        public void RaycastInGrid()
        {
            ...
            if(Physics.Raycast(ray, out RaycastHit hit))
            {
                ...
                int y = (int)(difference.z / nodeSize);
